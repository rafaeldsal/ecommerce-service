...
ALTER TABLE `tbl_order_history`
    ADD CONSTRAINT `fk_order_history_order` FOREIGN KEY (`order_id`) REFERENCES `tbl_order`(`order_id`);
...
ALTER TABLE `tbl_payment`
    ADD CONSTRAINT `fk_payments_orders` FOREIGN KEY (`order_id`) REFERENCES `tbl_order`(`order_id`);
